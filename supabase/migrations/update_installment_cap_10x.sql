...
-- Remove as parcelas de 11 a 21 — não existem mais. Precisa vir ANTES de
-- reapertar a constraint abaixo: o Postgres valida um CHECK novo contra as
-- linhas que já existem na hora de criar, então com as linhas >10 ainda lá
-- a constraint nova (1-10) nunca conseguiria ser criada.
