    ...
    <footer className="bg-gray-100 mt-16 md:mt-24 border-t border-gray-200 fade-in-section">
      <div className="container mx-auto py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <Logo src={affiliate.logo} name={affiliate.name} imgClassName="h-12 mb-4" textClassName="text-2xl font-bold tracking-tight text-gray-900 block mb-4" fallbackImage="dark" />
