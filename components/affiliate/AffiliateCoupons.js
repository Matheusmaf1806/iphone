...
export default function AffiliateCoupons({ affiliateId, commissionRate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingCoupon ? '/api/affiliate/coupons' : '/api/affiliate/coupons';
  ...
  const handleDelete = async (couponId) => {
    ...
    try {
      const response = await fetch(`/api/affiliate/coupons?id=${couponId}`, {
        method: 'DELETE'
      });
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Gerencie seus cupons de desconto (desconto vem da sua margem de {commissionRate}%)
          </p>
        </div>
        <button
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Máximo: {commissionRate}% (sua margem)
                </p>
              </div>
