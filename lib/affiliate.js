...
function getDefaultConfig() {
  return {
    ...
    name: 'Loja',
    logo: '',
    favicon: '/logo/brand_pet_logo_azul.png',
    brandColor: '#f60c49',
    commissionRate: 0.10,
...
function mapAffiliateToConfig(affiliate) {
  return {
    ...
    slug: affiliate.slug,
    name: affiliate.name,
    logo: affiliate.logo_url || 'https://brandpet.vercel.app/logo/brand_pet_logo_bege.png',
    favicon: affiliate.favicon_url || '/logo/brand_pet_logo_azul.png',
    brandColor: affiliate.primary_color || '#f60c49',
