...
const CROSS_SELL_MAP = {
  'coleiras': ['guias', 'passeio', 'acessorios'],
  'guias': ['coleiras', 'passeio', 'acessorios'],
  'passeio': ['coleiras', 'guias', 'acessorios'],
  'racoes': ['petiscos', 'higiene-e-saude', 'brinquedos'],
  'petiscos': ['racoes', 'brinquedos', 'higiene-e-saude'],
  'brinquedos': ['petiscos', 'camas-e-casas', 'acessorios'],
  'acessorios': ['coleiras', 'guias', 'brinquedos'],
  'higiene-e-saude': ['farmacia', 'limpeza', 'racoes'],
  'camas-e-casas': ['brinquedos', 'limpeza', 'acessorios'],
  'farmacia': ['higiene-e-saude', 'racoes', 'petiscos'],
  'limpeza': ['higiene-e-saude', 'camas-e-casas', 'acessorios'],
};
